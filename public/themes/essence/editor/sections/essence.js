				...
				<div class="single_widget_area">
					...
					<div class="subscribtion_form">
						<form action="#" method="post">
							...
							<button type="submit" class="submit"><i class="la la-long-arrow-right" aria-hidden="true"></i></button>
						</form>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-md-6">
				<div class="single_widget_area">
					<div class="footer_social_area">
						<a href="#" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Facebook"><i class="la la-facebook" aria-hidden="true"></i></a>
						<a href="#" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Instagram"><i class="la la-instagram" aria-hidden="true"></i></a>
						<a href="#" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Twitter"><i class="la la-twitter" aria-hidden="true"></i></a>
						<a href="#" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Pinterest"><i class="la la-pinterest" aria-hidden="true"></i></a>
						<a href="#" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Youtube"><i class="la la-youtube-play" aria-hidden="true"></i></a>
					</div>
				</div>
			</div>
		</div>
