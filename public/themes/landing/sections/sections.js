...
Vvveb.Sections.add("base/2-columns", {
    ...
    html: `<section class="" title="two columns">
  <div class="container">
    <div class="p-5">
      <div class="row">
        <div class="col">
    ...
    html: `<section class="" title="three columns">
  <div class="container">
    <div class="p-5">
      <div class="row">
        <div class="col">
  ...
  <div class="container">
    ...
    html: `<section class="" title="six columns">
  <div class="container">
    <div class="p-5">
      <div class="row">
        <div class="col">
    ...
    html: `<section class="" title="eight columns">
  <div class="container">
    <div class="p-5">
      <div class="row">
        <div class="col">
    ...
    html: `<section class="" title="twelve columns">
  <div class="container">
    <div class="p-5">
      <div class="row">
        <div class="col">
    ...
    html: `<section class="" title="blank">
  <div class="container">
    <div class="p-5">
      <h1>Heading</h1>
    </div>
...
Vvveb.Sections.add("contact-form/contact-form-2", {
  ...
  <div class="container py-5 my-5">
    ...
    image: Vvveb.themeBaseUrl + "/screenshots/contact-form/contact-form-10-thumb.jpeg",
  ...
  <div class="container">
    ...
    image: Vvveb.themeBaseUrl + "/screenshots/contact-form/contact-form-11-thumb.jpeg",
  ...
  <div class="container">
    ...
    image: Vvveb.themeBaseUrl + "/screenshots/contact-form/contact-form-12-thumb.jpeg",
  ...
  <div class="container-fluid p-0">
    ...
    image: Vvveb.themeBaseUrl + "/screenshots/contact-form/contact-form-13-thumb.jpeg",
  ...
  <div class="container">
	...
	Vvveb.SectionsGroup["Contact form"] = ["contact-form/contact-form-2","contact-form/contact-form-3","contact-form/contact-form-6","contact-form/contact-form-8","contact-form/contact-form-9","contact-form/contact-form-10","contact-form/contact-form-11","contact-form/contact-form-12","contact-form/contact-form-13"];
...
Vvveb.Sections.add("navigation/navigation-1", {
        ...
        <ul class="list-inline">
          <li class="list-inline-item">
            <a href="tel:5511112377">
              ...
              <span class="d-none d-md-inline text-muted"> +55 (111) 123 777</span>
            </a>
          </li>
          <li class="list-inline-item">
            <a href="mailto:contact@mysite.com">
              <i class="la la-envelope"></i>
              <span class="d-none d-md-inline text-muted">contact@mysite.com</span>
            </a>
          </li>
                    ...
                    <table class="table cart-table align-middle mb-0">
                      <tbody>
                        ...
                        <tr data-v-cart-product>
                          ...
                          <td class="text-end">
                            <a type="button" data-bs-toggle="tooltip" title="" class="btn btn-outline-secondary btn-sm border-0" data-v-vvveb-action="removeFromCart" data-v-cart-product-remove-url>
                              <i class="la la-times"></i>
                            </a>
                          </td>
                        </tr>
                      ...
                      <table class="table mb-0 cart-table cart-total" cellspacing="0">
                        <tfoot>
                          <tr data-v-cart-total>
                            ...
                            <td class="text-end" data-v-cart-total-value_formatted data-v-if="total.value > 0">$101.00</td>
                            <td class="text-end" data-v-cart-total-text data-v-if="total.text">$101.00</td>
                          </tr>
                          <tr data-v-cart-total>
                            <td colspan="5" class="text-end">
        ...
        <form class="d-flex">
          ...
          <div class="input-group">
            ...
            <span class="input-group-append">
              <button class="btn btn-outline-secondary border-0 la-flip-horizontal" type="button">
  ...
  <div class="container">
    ...
    <div class="navbar navbar-expand-md navbar-dark">
      <a class="navbar-brand" href="/" data-v-url-params='{"host":"www.*.*"}'>
        <img src="img/logo-white.png" class="logo-default">
        <img src="img/logo.png" class="logo-sticky">
      </a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
...
Vvveb.Sections.add("posts/posts-1", {
  ...
  <div class="container">
    ...
    name: "Post 3",
    image: Vvveb.themeBaseUrl + "/screenshots/posts/post-3-thumb.jpeg",
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-8 text-center">
        ...
        <h6 class="subtitle font-weight-normal">You can relay on our amazing features list and also our user services will be great experience for you without doubt</h6>
      </div>
    ...
    name: "Post 4",
    image: Vvveb.themeBaseUrl + "/screenshots/posts/post-4-thumb.jpeg",
  ...
  <div class="container">
    ...
    name: "Post 5",
    image: Vvveb.themeBaseUrl + "/screenshots/posts/post-5-thumb.jpeg",
  ...
  <div class="container">
    ...
    name: "Post 6",
    image: Vvveb.themeBaseUrl + "/screenshots/posts/post-6-thumb.jpeg",
  ...
  <div class="container">
	...
	Vvveb.SectionsGroup["Posts"] = ["posts/posts-1","posts/posts-2","posts/post-3","posts/post-4","posts/post-5","posts/post-6"];
        ...
        <article class="single-product-wrapper">
          ...
          <div class="product-img">
            <a href="/product/product-one" data-v-product-url title="">
              ...
              <img src="img/demo/video-1.jpg" data-v-product-alt alt="" data-v-product-image="thumb" />

              <!-- Hover Thumb -->
              <img class="hover-img" src="img/demo/video-2.jpg" data-v-product-alt alt="" data-v-product-image-1="thumb" />
            </a>

            <!-- Favourite -->
            <div class="product-favourite">
              <a href="/product/product-one" data-v-product-url data-v-product-title class="la la-heart"></a>
            </div>
          </div>
...
Vvveb.Sections.add("showcase/showcase-1", {
  ...
  <div class="container">
    <div class="row align-items-center w-100">
      ...
      <div class="col-md-8 col-sm-12 col-img">
        <img class="img-fluid" src="img/builder.svg">
      </div>
    </div>
  </div>
</section>`
  ...
  <div class="container">
	...
	Vvveb.SectionsGroup["Showcase"] = ["showcase/showcase-1","showcase/showcase-2","showcase/showcase-3","showcase/showcase-4","showcase/showcase-5","showcase/showcase-6","showcase/showcase-7","showcase/showcase-8","showcase/showcase-9","showcase/showcase-10","showcase/showcase-11"];
Vvveb.Sections.add("team/team-1", {
  ...
  <div class="container">
    ...
    name: "Team 7",
    image: Vvveb.themeBaseUrl + "/screenshots/team/team-7-thumb.jpeg",
  ...
  <div class="container">
    ...
    name: "Team 11",
    image: Vvveb.themeBaseUrl + "/screenshots/team/team-11-thumb.jpeg",
  ...
  <div class="container">
	...
	Vvveb.SectionsGroup["Team"] = ["team/team-1","team/team-2","team/team-5","team/team-6","team/team-7","team/team-11"];
Vvveb.Sections.add("testimonials/testimonials-1", {
  ...
  <div class="container">
    ...
    <div class="row text-center">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded shadow testimonial">
