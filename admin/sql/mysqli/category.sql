-- Categories
	...
	BEGIN
		...
		SELECT DISTINCT categories.taxonomy_item_id, @taxonomy_item_id := categories.taxonomy_item_id, categories.*, td.*, td.description as description, categories.taxonomy_item_id as array_key
